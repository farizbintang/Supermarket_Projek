...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <a href="../input_obat.php">Input Data</a>
	    <table border="1">
      <table class="table table-bordered table-dark table-hover">
        ...
        foreach ($db->tampil_data() as $data) {  ?>
          <tr>
            ...
            <td>
              <a href="../edit_obat.php?id=<?php echo $data['kode_obat'] ?>&aksi=edit">Edit</a>
              <a href="../../controller/proses_obat.php?id=<?php echo $data['kode_obat'] ?>&aksi=hapus">Hapus</a>
            </td>
          </tr>
        <?php
        }
