...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <a href="../int_transaksi.php">Input Data</a>
	    <table border="1">
      <table class="table table-bordered table-dark table-hover">
        ...
        foreach ($db->tampil_data() as $data) {  ?>
          <tr>
            ...
            <td>
              <a href="../edt_transaksi.php?id=<?php echo $data['kode_transaksi'] ?>&aksi=edit">Edit</a>
              <a href="../../controller/ps_transaksi.php?id=<?php echo $data['kode_transaksi'] ?>&aksi=hapus">Hapus</a>
            </td>
          </tr>
        <?php
        }
