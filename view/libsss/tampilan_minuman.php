...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      <div class="p-4 pt-5">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a href="../../regis.php">Tambah Akun Pegawai</a>
          </li>
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <a href="../int_minuman.php">Input Data</a>
	    <table border="1">
      <table class="table table-bordered table-dark table-hover">
        ...
        foreach ($db->tampil_data() as $data) {  ?>
          <tr>
            ...
            <td>
              <a href="../edt_minuman.php?id=<?php echo $data['kode_minuman'] ?>&aksi=edit">Edit</a>
              <a href="../../controller/ps_minuman.php?id=<?php echo $data['kode_minuman'] ?>&aksi=hapus">Hapus</a>
            </td>
          </tr>
        <?php
        }
