			...
			<div class="container">
				<div class="row">
					<div class="booking-form">
						...
						<form action="../controller/proses_obat.php?aksi=update" method="post">
						<?php foreach ($db->edit($_GET['id']) as $data) { ?>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Kode Obat</span>
										<input class="form-control" type="hidden" name="kode_obat" value="<?php echo $data['kode_obat']?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Nama Obat</span>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Jenis Obat</span>
                                        <input class="form-control" type="text" name="jenis_obat" value="<?php echo $data['jenis_obat']?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
