					...
					<div class="booking-form">
						<div class="booking-bg">
							<div class="form-header">
								<h2>Input Data Minuman</h2>
                                
								<p>Form Untuk Input Data Minuman</p>
							</div>
						</div>
						<form action="../controller/proses_minuman.php?aksi=tambah" method="post">
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="merk_minuman" required>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="jenis_minuman" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
