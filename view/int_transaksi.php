					...
					<div class="booking-form">
						<div class="booking-bg">
							<div class="form-header">
								...
								<p>Form Untuk Input Data Transaksi</p>
							</div>
						</div>
						<form action="../controller/ps_transaksi.php?aksi=tambah" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Kode Transaksi</span>
										<input class="form-control" type="text" name="kode_transaksi" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="kode_minuman" required>
									</div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Kode Obat</span>
                                        <input class="form-control" type="text" name="kode_obat" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Jumlah Transaksi</span>
										<input class="form-control" type="text" name="jml_transaksi" required>
									</div>
								</div>
							</div>
							<div class="form-group">
								<span class="form-label">Tanggal Transaksi</span>
								<input class="form-control" type="date" name="tanggal_transaksi" required>
							</div>
							<div class="form-btn">
