			...
			<div class="container">
				<div class="row">
					<div class="booking-form">
						...
						<form action="../controller/proses_makanan.php?aksi=update" method="post">
						<?php foreach ($db->edit($_GET['id']) as $data) { ?>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Kode Makanan</span>
										<input class="form-control" type="hidden" name="kode_makanan" value="<?php echo $data['kode_makanan']?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">Merk Makanan</span>
										<input class="form-control" type="text" name="merk_makanan" value="<?php echo $data['merk_makanan']?>" required>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="jenis_makanan" value="<?php echo $data['jenis_makanan']?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
