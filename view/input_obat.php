					...
					<div class="booking-form">
						<div class="booking-bg">
							<div class="form-header">
								...
								<p>Form Untuk Input Data Obat</p>
							</div>
						</div>
						<form action="../controller/proses_obat.php?aksi=tambah" method="post">
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="jenis_obat" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
